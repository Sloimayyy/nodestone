package com.sloimay.nodestonecore.simulation.backends.mamba.graph
        ...
        fun fromIR(graph: RedstoneBuildIR): MambaGraphResult {
            ...
            for (node in graph.getNodes()) {
                val mambaNode = when (node) {
                    ...
                    is RsIrTorch -> com.sloimay.nodestonecore.simulation.backends.mamba.graph.nodes.MambaTorchNode(
                        node.position,
                        node.lit
                    )
