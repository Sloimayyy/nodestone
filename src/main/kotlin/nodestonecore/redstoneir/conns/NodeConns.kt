...
val BS_TO_CONNS = listOf(
    ...
    BlockState.fromStr("minecraft:polished_blackstone_button") to ButtonConns(),
    BlockState.fromStr("minecraft:oak_button") to ButtonConns(),
    BlockState.fromStr("minecraft:birch_button") to ButtonConns(),
    BlockState.fromStr("minecraft:spruce_button") to ButtonConns(),
    BlockState.fromStr("minecraft:jungle_button") to ButtonConns(),
    BlockState.fromStr("minecraft:acacia_button") to ButtonConns(),
    BlockState.fromStr("minecraft:dark_oak_button") to ButtonConns(),
    BlockState.fromStr("minecraft:warped_button") to ButtonConns(),
    BlockState.fromStr("minecraft:crimson_button") to ButtonConns(),
    BlockState.fromStr("minecraft:bamboo_button") to ButtonConns(),
    BlockState.fromStr("minecraft:cherry_button") to ButtonConns(),
    BlockState.fromStr("minecraft:mangrove_button") to ButtonConns(),

    BlockState.fromStr("minecraft:stone_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:polished_blackstone_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:oak_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:birch_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:spruce_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:jungle_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:acacia_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:dark_oak_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:warped_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:crimson_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:bamboo_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:cherry_pressure_plate") to PressurePlateConns(),
    BlockState.fromStr("minecraft:mangrove_pressure_plate") to PressurePlateConns(),
